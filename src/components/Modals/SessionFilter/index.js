...
const SessionFilterModal = React.forwardRef((props, ref) => {
      ...
      <View style={styles.container}>
        ...
        <View style={styles.contentContainer}>
          ...
          <Touchable
            style={styles.selectionTextContainer}
            onPress={handleOnPress}>
            <EurostileBold style={styles.selectionText}>Schedule</EurostileBold>
          </Touchable>

          <Touchable
            style={styles.selectionTextContainer}
            onPress={handleOnPress}>
            <EurostileBold style={styles.selectionText}>Booked</EurostileBold>
          </Touchable>
        </View>
      </View>
    </ModalHOC>
